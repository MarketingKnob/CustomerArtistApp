    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (allAtristListDTOList.get(position).getArtist_commission_type().equalsIgnoreCase("0")) {
            if (allAtristListDTOList.get(position).getCommission_type().equalsIgnoreCase("0")) {
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + mContext.getResources().getString(R.string.hr_add_on)+" "+ allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getCategory_price());
                ...
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + mContext.getResources().getString(R.string.hr_add_on)+" "+ allAtristListDTOList.get(position).getCategory_price() + "%");
            } else {
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + mContext.getResources().getString(R.string.hr_add_on)+" "+ allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getCategory_price());
            }
        } else {
            if (allAtristListDTOList.get(position).getCommission_type().equalsIgnoreCase("0")) {
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + " "+mContext.getResources().getString(R.string.fixed_rate_add_on)+" "+ allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getCategory_price());
            } else if (allAtristListDTOList.get(position).getCommission_type().equalsIgnoreCase("1") && allAtristListDTOList.get(position).getFlat_type().equalsIgnoreCase("2")) {
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + " "+mContext.getResources().getString(R.string.fixed_rate_add_on)+" "+ allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getCategory_price());
            } else if (allAtristListDTOList.get(position).getCommission_type().equalsIgnoreCase("1") && allAtristListDTOList.get(position).getFlat_type().equalsIgnoreCase("1")) {
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + " "+mContext.getResources().getString(R.string.fixed_rate_add_on)+" "+ allAtristListDTOList.get(position).getCategory_price() + "%");
            } else {
                holder.CTVartistchargeprh.setText(allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getPrice() + " "+mContext.getResources().getString(R.string.fixed_rate_add_on)+" "+ allAtristListDTOList.get(position).getCurrency_type() + allAtristListDTOList.get(position).getCategory_price());
            }
        }
