...
public class DrawMarker {
    ...
    public static com.samyotech.fabcustomer.ui.DrawRoute.DrawMarker INSTANCE;

    public static com.samyotech.fabcustomer.ui.DrawRoute.DrawMarker getInstance(Context context) {
        INSTANCE = new com.samyotech.fabcustomer.ui.DrawRoute.DrawMarker(context);
        return INSTANCE;
    }
